...
class JagrutJoshi:
    ...
    skills = {
        ...
        "ml_libs"   : ["NumPy", "Pandas", "Matplotlib", "Seaborn"],
        "tools"     : ["Git", "GitHub", "VS Code", "Jupyter"]
    }

    currently = [
        "📖 Studying Machine Learning & Deep Learning",
        "🔬 Exploring Data Mining & Digital Image Processing",
        "🏗️  Building real-world projects",
        "🎯 Actively seeking ML/AI Internships"
    ]

    motto = "Ship code. Learn fast. Repeat. 🚀"
```
...
> A full-stack, AI-powered personal health tracking system with smart pattern detection, voice input, emotion detection, streaming chat, long-term memory, and automated PDF health reports — powered by a local LLM via LM Studio.

<div align="center">

| Feature | Tech Used |
|---------|-----------|
| 🤖 Local AI Chat (Streaming) | LM Studio · OpenAI-compatible API |
| 🎙️ Voice Input + TTS Readback | Web Speech API |
| 😰 Emotion Detection | Heuristic NLP + LLM classification |
| 🧠 Long-term Memory | Auto-extraction across sessions |
| 📊 Interactive Dashboard | Chart.js · Radar · Trend Charts |
| 🔍 Smart Pattern Detection | 10+ health alert rules |
| 📄 AI PDF Report Generator | jsPDF · Weekly health summaries |
| 🔐 Secure Auth System | SHA-256 · Sessions · Route Guards |
...
🔄  Build 3+ AI/ML projects for portfolio
🔄  Contribute to an Open Source project
🔄  Land an ML/AI Internship
⬜  Deploy a model to production
⬜  Master Deep Learning (CNNs, RNNs, Transformers)
...
> *"An expert at anything was once a beginner. Stay consistent, stay hungry."*
...
<em>Feel free to reach out — always happy to connect!</em>
